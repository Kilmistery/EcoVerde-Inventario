...
from ventas.mostrar_ventas import ventana_mostrar_ventas
import sqlite3
...
btn_ver_ventas = tk.Button(ventana, text="Ver Ventas", width=20, command=ventana_mostrar_ventas)
btn_ver_ventas.pack(pady=5)
